...
boxplot1(Si, main = "Si", labels = x_labels)
boxplot1(STi, main = "STi", labels = x_labels)
...
# plot main and total separately
par(mfrow = c(1, 2))
boxplot1(Si, main = "Si", Si_lb, Si_ub, labels = x_labels)
boxplot1(STi, main = "STi", STi_lb, STi_ub, labels = x_labels)
