...
#' @import ggplot2 matrixStats cowplot gridExtra FRACTION
#' @importFrom grDevices adjustcolor rainbow
#' @importFrom graphics abline axis boxplot legend matlines matplot par plot points polygon
#' @importFrom stats ecdf median quantile rnorm runif sd var
